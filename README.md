<p align="center">
  <img src="./assets/profile-header.svg" alt="Nithish R — Software Development Engineer building reliable event-driven systems" width="100%">
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>APIs, concurrency, durable state, validation, security, and explicit failure recovery.</p>
    </td>
    <td width="50%" valign="top">
      <h3>↝ Event-driven workflows</h3>
      <p>Transactional publication, idempotent delivery, bounded retries, compensation, and observable state transitions.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>☁️ Cloud and operations</h3>
      <p>Containerized delivery, CI/CD, health signals, metrics, and infrastructure designed around operational feedback.</p>
    </td>
    <td width="50%" valign="top">
      <h3>◫ Product delivery</h3>
      <p>Focused interfaces built around clear service boundaries, useful workflows, and well-designed data models.</p>
    </td>
  </tr>
</table>
